 ...
 * @var bool|null $submitFullWidth
 * @var bool|null $hasFilters
 * @var string|null $fieldsView
 * @var array|null $fieldsData
 * @var bool|null $reactiveHasFilters
 * @var array|null $filterDefaults
 * @var array|null $ignoredFilterKeys
 */
