        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
                <?php if (is_superadmin()): ?>
                    ...
                    <form method="post" action="<?= route_to('admin.iam.permissions.delete', $itemId) ?>" onsubmit="return confirm('<?= esc(confirm_delete_message($permission['code'] ?? $permission['resource'] ?? null), 'js') ?>');">
                        <?= csrf_field() ?>
